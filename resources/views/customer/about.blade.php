...
@section("content")
    ...
    <div class="container">
        <div class="row">
            <div class="wrap-about">
                ...
                <div class="about-item" style="margin-top: 30px;">
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 no-padding-right">
                        <!-- SLIDER -->
                            ...
                            <div id="index12" class="owl-carousel  owl-theme">
                                ...
                                <div class="item">
                                    <img alt="Third slide" src="pexels-anton-imbro-2752177.jpg" class="img-responsive">
                                </div>
                            </div>
                ...
                <div class="about-item about-right">
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6  no-padding-left col-lg-push-6 col-md-push-6 " style="margin-top: 30px;">
                        <div class="img">
                            <img src="#" alt="#" class="img-responsive">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 no-padding-right col-lg-pull-6 col-md-pull-6" style="margin-top: 30px;">
                        <div class="text">
                            <h2 class="heading">WHY YOU SHOULD CHOOSE US?</h2>
                            <div class="desc">
    ...
    <!-- TEAM -->
    <section class="section-team" style="margin-top: 50px;">
        <div class="container">
            <div class="team">
                <h2 class="heading text-center">Team Member</h2>
                <p class="sub-heading text-center">Đây là những thành viên của </p>
                <div class="team_content" style="margin-top: 30px;">
                    <div class="row" style="padding-left: 30px;">
                        <!-- ITEM -->
                        <div class="col-xs-4 col-md-2" style="margin-left: 30px;">
                            <div class="team_item text-center">
                                <div class="img">
                                    <a href="#"><img src="images/About/about-3.png" alt="#"></a>
                                </div>
                                <div class="text">
                                    <h2>JESSICA ALBA</h2>
                        ...
                        <div class="col-xs-4 col-md-2" style="margin-left: 30px;">
                            <div class="team_item text-center">
                                <div class="img">
                                    <a href="#"><img src="images/About/about-4.png" alt="#"></a>
                                </div>
                                <div class="text">
                                    <h2>Robet WILIAM</h2>
                        ...
                        <div class="col-xs-4 col-md-2" style="margin-left: 30px;">
                            <div class="team_item text-center">
                                <div class="img">
                                    <a href="#"><img src="images/About/about-5.png" alt="#"></a>
                                </div>
                                <div class="text">
                                    <h2>Adam</h2>
                        ...
                        <div class="col-xs-4 col-md-2" style="margin-left: 30px;">
                            <div class="team_item text-center">
                                <div class="img">
                                    <a href="#"><img src="images/About/about-6.png" alt="#"></a>
                                </div>
                                <div class="text">
                                    <h2>David Gari</h2>
                                    <span>Lorem lipsum</span>
