...
<section class="body-page page-v1">
    <div class="container">
        <div class="content">
{{--            <element class="alert alert-info fade in">--}}
{{--                <button type="button" class="close" data-dismiss="alert">×</button>--}}
{{--                <strong>Lorem Ipsum is simply dummy</strong> text of the printing and typesetting industry. Lorem Ipsum--}}
...
{{--            </element>--}}
            ...
            <p>I don’t have an account &nbsp;- &nbsp; <a href="/register">Register account</a></p>
            <p>Forgot Password? &nbsp;- &nbsp; <a href="">Click here to change password</a></p>
        </div>
    </div>
</section>
<!-- END/BODY-LOGIN-->
