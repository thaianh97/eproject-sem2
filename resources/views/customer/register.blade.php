        ...
        <nav class="navbar navbar-fixed-top bg-menu">
            <div class="container">
                <div class="navbar-header ">
                    ...
                    <a class="navbar-brand" href="file:///E:/Xampp/htdocs/skyline/index.html" title="Skyline"><img src="images/Home-1/sky-logo-header.png" alt="#"></a>
                </div>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown ">
                            ...
                            <ul class="dropdown-menu icon-fa-caret-up submenu-hover">
                                ...
                                <li class="submenu-hover1">
                                    <a href="restaurants_1.html" class="dropdown-toggle" data-toggle="dropdown">Restaurant <b class="caret"></b></a>
                                    <ul class="dropdown-menu dropdown-margin">
                                        <li><a href="restaurants_1.html">Restaurant 1</a></li>
                                        <li><a href="restaurants_2.html">Restaurant 2</a></li>
                                        <li><a href="restaurants_3.html">Restaurant 3</a></li>
                                        <li><a href="restaurants_4.html">Restaurant 4</a></li>
                                    </ul>
                                </li>
                                <li class="submenu-hover1">
...
<section class="body-page page-v1 page-v2">
    <div class="container">
        <div class="content">
            ...
            <h5 class="p-v1">If you don't have account! Register and feeling</h5>
            <form action="/register" method="post">
                ...
                <div class="form-group">
                    <input type="email" name="email" class="form-control" required="required" title="" placeholder="Email *">
                    @if ($errors->has('email'))
                ...
                <div class="form-group">
                    <input id="password-field1" type="password" class="form-control" name="confirm_password" placeholder="Confirm Password *">
