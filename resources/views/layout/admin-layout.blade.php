                    ...
                    <li class="active">
                        ...
                        <ul class="submenu-angle" aria-expanded="false">
                            ...
                            <li><a title="Dashboard v.3" href="/admin"><span
                                        class="mini-sub-pro">Tài chính</span></a></li>
                            <li><a title="Area " href="/admin/areas"><span
                                        class="mini-sub-pro">Khu vực</span></a></li>
                        </ul>
                    </li>
                    <li>
...
{{--                                        class="mini-sub-pro">CustomerAdd  </span></a></li>--}}
...
{{--                            </li>--}}
                    ...
                    <li>
                        <a class="has-arrow" href="mailbox.html" aria-expanded="false"><i
                                ...
                                class="mini-click-non">HDV</span></a>
                        <ul class="submenu-angle" aria-expanded="false">
                            <li><a title="Google Map" href="/admin/tourGuides"><span
                                        class="mini-sub-pro">Danh sách hdv </span></a></li>
...
{{--                            </li>--}}
                    ...
                    <li>
                        <a class="has-arrow" href="mailbox.html" aria-expanded="false"><i
                                ...
                                class="mini-click-non">Giao dich</span></a>
                        <ul class="submenu-angle" aria-expanded="false">
                            <li><a title="" href="/admin/transactions"><span
                                        class="mini-sub-pro">Danh sách </span></a></li>
                            <li><a title="" href="/admin/pay-accept-transactionDetails"><span class="mini-sub-pro">Đợi thanh toán</span></a></li>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <div class="breadcomb-wp">
                                        ...
                                        <div class="breadcomb-ctn">
                                            ...
                                            @yield('title')
                                            <p>Welcome <span class="bread-ntd">{{\App\Admin::where('account_id',session('id'))->first()->full_name}}</span></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
