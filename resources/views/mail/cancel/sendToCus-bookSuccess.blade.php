    ...
    <tr>
        ...
        <td class="container">
            <div class="content">
                ...
                <span class="preheader">Hướng dẫn viên {{$tourGuide->full_name}} đã hủy đơn hàng đặt lịch tour của bạn.</span>
                <table class="main">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        ...
                                        <p>Xin vui lòng liên hệ tổng đài để được hỗ trợ hoàn lại tiền
                                            và lựa chọn hướng dẫn viên khác để đặt lịch đi tour.</p>
