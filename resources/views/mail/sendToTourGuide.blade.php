    ...
    <tr>
        ...
        <td class="container">
            <div class="content">
                ...
                <span class="preheader">Hướng dẫn viên {{$tourGuide->full_name}} có yêu cầu đặt lịch đi tour mới
                    từ khách hàng {{$customer->full_name}}</span>
                <table class="main">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <p>Xin vui lòng xác nhận đặt lịch đi tour
                                            và phản hồi thông tin đến khách hàng trong thời gian sớm nhất.</p>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" class="btn btn-primary">
                                            ...
                                            <tr>
                                                <td align="left">
                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                        <tbody>
                                                        <td><a href="https://eproject-sem2-tconnect.herokuapp.com/admin/customers"
                                                               target="_blank">Đi đến danh sách</a>
                                                        </tbody>
                                                    </table>
                                                </td>
                                            </tr>
